...
_EFFECTIVE_ADDRESS_WITH_BASE_INDEX_DISPLACEMENT: str = rf"(?:{_ONE_OR_MORE_OPEN_BRACKETS}[ \t]*)(?:{_REGISTER}[ \t]*)\+[ \t]*(?:{_REGISTER}[ \t]*)*(?:[+-][ \t]{_CONSTANT_EXPRESSION}[ \t]*)+(?:{_ONE_OR_MORE_CLOSE_BRACKETS})"
